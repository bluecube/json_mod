...
def tokenize_iterable(string):
    ...
    return tokenize.tokenize(characters, True)

def simple_test():
    assert_iterables_equal(tokenize_iterable('abcd { , [\ntrue "xyz"\n\n\n7 /* this is a comment\n! */ a'),
...
def identifier_test():
    data = 'simple'
    assert_iterables_equal(tokenize_iterable(data),
...
def json_number_test():
    assert_iterables_equal(tokenize_iterable('1'),
                           [('number', tokenize.Position(None, 1, 1), 1)])
    assert_iterables_equal(tokenize_iterable('42'),
                           [('number', tokenize.Position(None, 1, 1), 42)])
    assert_iterables_equal(tokenize_iterable('0.2'),
                           [('number', tokenize.Position(None, 1, 1), 0.2)])
    assert_iterables_equal(tokenize_iterable('1.2'),
                           [('number', tokenize.Position(None, 1, 1), 1.2)])
    assert_iterables_equal(tokenize_iterable('1.25'),
                           [('number', tokenize.Position(None, 1, 1), 1.25)])
    assert_iterables_equal(tokenize_iterable('42.5'),
                           [('number', tokenize.Position(None, 1, 1), 42.5)])
    assert_iterables_equal(tokenize_iterable('42.52'),
                           [('number', tokenize.Position(None, 1, 1), 42.52)])
    assert_iterables_equal(tokenize_iterable('5e0'),
                           [('number', tokenize.Position(None, 1, 1), 5e0)])
    assert_iterables_equal(tokenize_iterable('1e1'),
                           [('number', tokenize.Position(None, 1, 1), 1e1)])
    assert_iterables_equal(tokenize_iterable('42E+1'),
                           [('number', tokenize.Position(None, 1, 1), 42e+1)])
    assert_iterables_equal(tokenize_iterable('1.2e-1'),
                           [('number', tokenize.Position(None, 1, 1), 1.2e-1)])
    assert_iterables_equal(tokenize_iterable('2e-10'),
    ...
    assert_iterables_equal(tokenize_iterable('0asdf'),
                           [('number', tokenize.Position(None, 1, 1), 0),
                            ('identifier', tokenize.Position(None, 1, 2), 'asdf')])

def ext_number_test():
    assert_iterables_equal(tokenize_iterable('0x1'),
                           [('ext_number', tokenize.Position(None, 1, 1), 1)])
    assert_iterables_equal(tokenize_iterable('0x10'),
                           [('ext_number', tokenize.Position(None, 1, 1), 16)])
    assert_iterables_equal(tokenize_iterable('0b01001'),
                           [('ext_number', tokenize.Position(None, 1, 1), 9)])
    assert_iterables_equal(tokenize_iterable('0o21'),
